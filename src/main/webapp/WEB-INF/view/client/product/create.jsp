                        ...
                        <div class="mt-5">
                            <div class="row">
                                <div class="col-md-6 col-12 mx-auto">
                                    ...
                                    <br>
                                    <form:form class="row g-3" action="/admin/user/create" method="post" modelAttribute="newProduct" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6 col-12 mb-3">
                                            ...
                                            <form:select class="form-select" path="target">
                                                ...
                                                <form:option value="DMONG-NHE">Mỏng nhẹ</form:option>
